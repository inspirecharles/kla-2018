...
class Results extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('kla', 'ID'),
            'game_id' => Yii::t('kla', 'Game ID'),
            'draw_id' => Yii::t('kla', 'Draw ID'),
            'draw_date' => Yii::t('kla', 'Draw Date'),
            'main_numbers' => Yii::t('kla', 'Main Numbers'),
            'supp_numbers' => Yii::t('kla', 'Supp Numbers'),
            'dividends' => Yii::t('kla', 'Dividends'),
        ];
    }
