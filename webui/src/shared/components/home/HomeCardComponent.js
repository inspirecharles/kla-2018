	                        		...
	                        		<div className="container">
										<div className="row game-row">
										    <div className="game-logo">
										    	<img className={"img-fluid "+this.props.game.variant+"-logo-lotto game-"+this.props.game.slug} src={"/img/variants/"+this.props.game.variant+"/"+this.props.game.slug+".png"} /> {this.props.game.name}
										    </div>
